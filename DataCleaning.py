...
df['Tot Ipotesi alta'] = df.groupby(['Anno', 'Quartiere', 'Genere'])['Ipotesi alta'].transform('sum')
df['Tot Ipotesi media'] = df.groupby(['Anno', 'Quartiere', 'Genere'])['Ipotesi media'].transform('sum')
